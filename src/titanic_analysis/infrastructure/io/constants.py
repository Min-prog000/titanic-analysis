...
SAVE_TREE_INDEX = 0
SAVE_TREE_FILE_PREFIX = "case"
SAVE_TREE_FILE_INDEX_PREFIX = "_tree_"

SAVE_MODEL_FILE_PREFIX_LIGHTGBM = "case_"
SAVE_MODEL_FILE_EXTENSION_LIGHTGBM = ".json"

SAVE_MODEL_ROOT_LIGHTGBM = ".\\model\\"
SAVE_MODEL_FILE_PARENT_LIGHTGBM = "\\case_"
